...
@ -- multiplica o numero por 2
        mov r1, #0            @ coloca o valor do primeiro elemento em r1
        mov r2, #1            @ coloca o segundo elemento em r2  
        mov r3, r0            @ passa o valor das iteracoes para outro contador, para o resultado ficar em r0  

loop_fibo:
        add r0, r1, r2        @ faz com que o atual seja igual a soma dos anteriores
        mov r1, r2            @ atualiza o valor presente  
        mov r2, r0            @ atualiza o valor anterior  
        sub r3, r3, #1        @ atualiza o contador de iteracoes para controle
        mov r0, r1
        cmp r3, #0            @ compara com o contador com 0
        bgt loop_fibo         @ pula para o fazer o loop novamente
